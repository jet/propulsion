...
- `CosmosStore`: Port from `Microsoft.Azure.Documents.ChangeFeedProcessor` (V2 CFP) to `Microsoft.Azure.Cosmos` (V3 CFP) `3.0.19-preview` [#113](https://github.com/jet/propulsion/pull/113)
