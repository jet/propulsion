...
- Changed dominant `ITimelineEvent` `EventBody` type from `byte[]` to `System.ReadOnlyMemory<byte>` [#169](https://github.com/jet/propulsion/pull/169)
- `StreamSpan`: Changed from a record to individual arguments of `FsCodec.StreamName` and `Streams.Default.Event` [#169](https://github.com/jet/propulsion/pull/169)
...
- `Feed`,`Kafka`: Replaced `Async` with `task` for supervision [#158](https://github.com/jet/propulsion/pull/158), [#159](https://github.com/jet/propulsion/pull/159)
