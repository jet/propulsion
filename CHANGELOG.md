...
- `Ingester`: Expose optional `ingesterStateInterval` and `commitInterval` control on Source factories [#154](https://github.com/jet/propulsion/pull/154) [#239](https://github.com/jet/propulsion/pull/239)
