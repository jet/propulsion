...
- `Propulsion.Kafka0` [![NuGet](https://img.shields.io/nuget/vpre/Propulsion.Kafka0.svg)](https://www.nuget.org/packages/Propulsion.Kafka0/). Same functionality/purpose as `Propulsion.Kafka` but targets older `Confluent.Kafka`/`librdkafka` version for backcompat. [Depends](https://www.fuget.org/packages/Propulsion.Kafka0) on `Jet.ConfluentKafka.FSharp` v `0.9.6`, `Serilog`
